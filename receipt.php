...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Mabasa Secondary School" : 'Mabasa Secondary School' ?></b></p>
	<hr>
	<div class="flex">
		<div class="w-50">
		...
		<div class="w-50">
			...
			<p>Paid Amount: <b>US$<?php echo isset($pay_arr[$_GET['pid']]) ? number_format($pay_arr[$_GET['pid']]['amount'],2): '' ?></b></p>
		...
		<tr>
			<td width="50%">
				...
				<tr>
					...
					<td class='text-right'><b>US$<?php echo ($row['amount']) ?></b></td>
				</tr>
				<?php
				}
				?>
				<tr>
					<th>Total</th>
					<th class='text-right'><b>US$<?php echo ($ftotal) ?></b></th>
				</tr>
				</table>
			</td>			
			<td width="50%">
			<p><b>Payment Details</b></p>
				<table width="100%" class="wborder">
					...
					<tr>
						<th>Total:</th>
						<th class='text-right'><b>US$<?php echo ($ptotal) ?></b></th>
					</tr>
				</table>
				<table width="100%">
					<tr>
						<td>Total Payable Fee:</td>
						<td class='text-right'><b>US$<?php echo ($ftotal) ?></b></td>
					</tr>
					<tr>
						<td>Total Paid:</td>
						<td class='text-right'><b>US$<?php echo ($ptotal) ?></b></td>
					</tr>
					<tr>
						<td>Balance:</td>
						<td class='text-right'><b>US$ <?php echo ($ftotal-$ptotal) ?></b></td>
					</tr>
				</table>
			</td>			
		</tr>
