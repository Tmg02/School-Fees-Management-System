...
<script>
	...
	$('#new_course').click(function(){
		uni_modal("New Classes and Fees Entry","manage_course.php",'large')
	...
	$('.delete_course').click(function(){
		_conf("Are you sure to delete this Fee ?","delete_course",[$(this).attr('data-id')])
	})
	function delete_course($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Fee successfully deleted",'success')
					setTimeout(function(){
						location.reload()
					},1500)
